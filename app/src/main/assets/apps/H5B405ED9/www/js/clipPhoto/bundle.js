				...
				Lrz.prototype._createBase64ForOldIOS = function () {
					...
					return new Promise(function (resolve) {
						!/* require */(/* empty */function () {
							var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(7)]; (function (MegaPixImage) {
				...
				Lrz.prototype._createBase64 = function () {
					...
					return new Promise(function (resolve) {
						if (UA.oldAndroid || UA.mQQBrowser || !navigator.userAgent) {
							!/* require */(/* empty */function () {
								var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(8)]; (function (JPEGEncoder) {
